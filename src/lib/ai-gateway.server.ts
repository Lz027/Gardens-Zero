...
/** Responses-API provider for the Lovable AI Gateway (OpenAI models). */
export function createGardensAi(lovableApiKey: string, initialRunId?: string) {
...
export const GARDENS_PROVIDER_OPTIONS = {
  openai: {
    forceReasoning: true,
